function enableSubmit(bool) {
    ...
    //dev环境ip
       function v_app_ip_dev() {
        ...
        else {flags[1]=true;lineState("app_ip_dev","");}
        v_submitbutton();
    }
    //test环境ip
       function v_app_ip_test() {
        ...
        else {flags[2]=true;lineState("app_ip_test","");}
        v_submitbutton();
    }
    //demo环境ip
       function v_app_ip_demo() {
        ...
        else {flags[3]=true;lineState("app_ip_demo","");}
        v_submitbutton();
    }
    //项目git地址
           function v_git_url() {
        ...
        else {flags[4]=true;lineState("git_url","");}
        v_submitbutton();
    }
